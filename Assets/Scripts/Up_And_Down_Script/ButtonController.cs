...
public class ButtonController : MonoBehaviour {
    ...
    public Text floorLevelText; // Reference to the Text component that displays the floor level

    private int floorLevel; // The current value of the floor level

    // Start is called before the first frame update
    void Start() {
        // Load the current value of the floor level from PlayerPrefs
        floorLevel = PlayerPrefs.GetInt("floorLevel", 0);
